...
in
{
  ...
  home.activation.proton-activation = lib.mkIf isLinux (lib.hm.dag.entryAfter ["writeBoundary"] ''
    ...
    ${mkProtonGEScript { version = "GE-Proton8-16"; sha256 = "sha256:0r11sf7pljw5rqlgbnkl6lkw2cpqyvd16vjp8f64hqjx4ma3947g"; }}
    ${mkProtonGEScript { version = "GE-Proton9-1"; sha256 = "sha256:1zc1c1scqnpxsfxj6micpgvn317k7gd48aya8m3c5v6nbi377nm1"; }}
  '');
}
